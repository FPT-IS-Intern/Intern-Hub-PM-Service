...
public interface TeamMemberService {
    ...
    PaginatedData<TeamMemberResponse> getMembers(Long teamId, int page, int size);
    PaginatedData<TeamMemberResponse> searchMembers(Long teamId, String keyword, int page, int size);
